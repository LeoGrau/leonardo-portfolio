...
function SidebarDock() {
  return (
    <>
      <div className="md:fixed md:w-fit md:left-0 md:top-[50%] md:translate-y-[-50%] md:z-30 md:bg-zinc-950 flex md:flex-col md:gap-4 md:rounded-r-lg md:px-3 md:py-6 md:mt-0 md:text-slate-200 gap-3 mt-3">
